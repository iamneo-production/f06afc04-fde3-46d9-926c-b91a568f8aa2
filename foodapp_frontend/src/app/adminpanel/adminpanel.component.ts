...
export class AdminpanelComponent {
  ...
  fetchCustomerDetails() {
    ...
    this.http.get<any[]>('https://8080-eaeeecbfecacfcdbceaeaadbdbabf.project.examly.io/customer')
      .subscribe(data => {
        this.customers = data;
  ...
  fetchRestaurantDetails() {
    ...
    this.showComplaints = false;
    this.http.get<any[]>('https://8080-eaeeecbfecacfcdbceaeaadbdbabf.project.examly.io/restaurant')
      .subscribe(data => {
  ...
  fetchComplaints() {
    ...
    this.showCustomer = false;
    this.showRestaurant = false;
    this.http.get<any[]>('https://8080-eaeeecbfecacfcdbceaeaadbdbabf.project.examly.io/contactus')
      .subscribe(data => {
  ...
  deleteCustomer(customer: any) {
    this.http.delete(`https://8080-eaeeecbfecacfcdbceaeaadbdbabf.project.examly.io/customer/${customer.id}`, { responseType: 'text' })
      .subscribe(() => {
  ...
  deleteRestaurant(restaurant: any) {
    this.http.delete(`https://8080-eaeeecbfecacfcdbceaeaadbdbabf.project.examly.io/restaurant/${restaurant.id}`, { responseType: 'text' })
      .subscribe(() => {
  ...
  deleteComplaint(complaint: any) {
    this.http.delete(`https://8080-eaeeecbfecacfcdbceaeaadbdbabf.project.examly.io/contactus/${complaint.id}`, { responseType: 'text' })
      .subscribe(() => {
