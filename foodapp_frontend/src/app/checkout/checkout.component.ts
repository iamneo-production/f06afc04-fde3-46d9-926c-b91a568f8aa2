...
finalTotal=this.cartService.finaltotal;
  ...
  makePayment() {
    const url = 'https://8080-eaeeecbfecacfcdbccbacbfccbbebfcae.project.examly.io/payment'; // Replace with your server's endpoint
  ...
  public createOrder() {
    const url = 'https://8080-eaeeecbfecacfcdbccbacbfccbbebfcae.project.examly.io/order';
