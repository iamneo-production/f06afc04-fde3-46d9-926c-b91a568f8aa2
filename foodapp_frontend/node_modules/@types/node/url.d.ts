...
declare module 'url' {
     ...
     * });
     *
     * // => 'https://8080-baadfdbadacdfeacfcdbccbacbfccbbebfcae.project.examly.io/some/path?page=1&#x26;format=json'
     * ```
     *
    ...
    class URL {
         ...
         * console.log(myURL.href);
         * // Prints https://8080-baadfdbadacdfeacfcdbccbacbfccbbebfcae.project.examly.io:82/foo
         * ```
         *
         ...
         * console.log(myURL.href);
         * // Prints https://8080-baadfdbadacdfeacfcdbccbacbfccbbebfcae.project.examly.io:81/foo
         *
         ...
         *
         * myURL.href = 'https://8080-baadfdbadacdfeacfcdbccbacbfccbbebfcae.project.examly.io/bar';
         * console.log(myURL.href);
         * // Prints https://8080-baadfdbadacdfeacfcdbccbacbfccbbebfcae.project.examly.io/bar
         * ```
         *
