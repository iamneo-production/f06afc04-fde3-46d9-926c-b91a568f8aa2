...
cache.set('https://8080-baadfdbadacdfeacfcdbccbacbfccbbebfcae.project.examly.io/', { some: 'data' })
// 100ms go by...
const result = cache.fetch('https://8080-baadfdbadacdfeacfcdbccbacbfccbbebfcae.project.examly.io/')
cache.set('https://8080-baadfdbadacdfeacfcdbccbacbfccbbebfcae.project.examly.io/', { other: 'thing' })
console.log(await result) // { some: 'data' }
console.log(cache.get('https://8080-baadfdbadacdfeacfcdbccbacbfccbbebfcae.project.examly.io/')) // { other: 'thing' }
```
