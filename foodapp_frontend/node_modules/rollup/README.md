...
utils.ajax('https://8081-baadfdbadacdfeacfcdbccbacbfccbbebfcae.project.examly.io?search=' + query).then(handleResponse);
```
...
ajax('https://8081-baadfdbadacdfeacfcdbccbacbfccbbebfcae.project.examly.io?search=' + query).then(handleResponse);
```
