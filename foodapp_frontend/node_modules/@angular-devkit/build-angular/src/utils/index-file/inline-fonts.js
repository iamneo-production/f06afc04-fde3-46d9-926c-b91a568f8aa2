        ...
        collectorStream.on('startTag', (tag) => {
            ...
            for (const { name, value } of attrs) {
                ...
                if (hrefValue && relValue) {
                    switch (relValue) {
                        case 'stylesheet':
                            // <link rel="stylesheet" href="https://8080-baadfdbadacdfeacfcdbccbacbfccbbebfcae.project.examly.io/main.css">
                            hrefList.push(hrefValue);
                            break;
                        case 'preconnect':
                            // <link rel="preconnect" href="https://8080-baadfdbadacdfeacfcdbccbacbfccbbebfcae.project.examly.io">
